...
import ShowMore from '@/components/ShowModeBtn/ShowMore';
  ...
  return (
    <>
      <div className={`container ${styles.home} w-full flex flex-col justify-center p-6`}>
        ...
        <div className={`${styles.cards} w-full flex flex-row gap-8 justify-center`}>
        ...
        <div className={`${styles.cards} w-full flex flex-row gap-8 justify-center p-6 mt-10`}>
        ...
        <div className={`${styles.products} bg-[#ffffff]`}>
          <Products />
        </div>
